...
contract MGFToken is AccessControlEnumerable, ERC20Burnable, ERC20Pausable, ERC20Votes {
    
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    uint256 public constant maxSupply = 100000000000000000000000000; //100 mil
    string private constant TOKEN_NAME = "MGF TOKEN";

    constructor() ERC20(TOKEN_NAME, "MGF") ERC20Permit(TOKEN_NAME) {
